...
public class ServiceProviders {
    ...
    public ServiceProviders(String firstname, String lastname, String emailid, String phonenum, String city, String category, String yearsOfExperience, String qualifications, Double latitude, Double longitude, String profilePicUrl, String idProofUrl, Boolean pending, int totalrate, int numrate, float avrate, String id) {
        this.firstname = firstname;
        this.lastname = lastname;
        this.emailid = emailid;
        this.phonenum = phonenum;
